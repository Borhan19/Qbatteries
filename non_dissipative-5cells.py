# -*- coding: utf-8 -*-
"""Non-dissipative, Time=pi/g, g=0.2*omega, Target=|0><0| |1><1|, 5cells.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1O8jN-fXuUEeuSgSM-4fcbsFQciiperGQ
...
def plot_iterations(opt_result):
    ...
    plt.legend()
    plt.show(fig)
    fig.savefig('Energyofthefield5cells-nodissipation.png')
...
objectives = [
    krotov.Objective(
        initial_state=qutip.tensor(qutip.ket("0"),qutip.ket("0"),qutip.ket("0"),qutip.ket("0"),qutip.ket("0"),qutip.ket("0")), target=qutip.tensor(qutip.ket("0"),qutip.ket("1"),qutip.ket("1"),qutip.ket("1"),qutip.ket("1"),qutip.ket("1")), H=H
      )
  ]
...
a=0
for i in range(0,nt):
  FinalStateB = np.trace(np.array(optimized_dynamics.states[i]*optimized_dynamics.states[i].dag()).reshape(2,2,2,2,2,2,2,2,2,2,2,2), axis1=0, axis2=6)
