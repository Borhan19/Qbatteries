# -*- coding: utf-8 -*-
"""Dissipative: Oscillator(Charger)-Qubit(Battery), Time=4pi/g, Target=|1><1|.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KaDWl92XDKE_WBDsVRvBMky_qc9XzsMo
...
def print_qubit_error(**args):
    ...
    for state_T in args['fw_states_T']:
        n=np.shape(state_T)[0]//2
        state_q_T = np.trace(np.array(state_T).reshape(n,2,n,2), axis1=0, axis2=2)        
